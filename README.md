...
[![Build Status](https://travis-ci.org/resuldeger/laravel-friendships.svg?branch=v1.0.21)](https://travis-ci.org/resuldeger/laravel-friendships) [![Code Climate](https://codeclimate.com/github/resuldeger/laravel-friendships/badges/gpa.svg)](https://codeclimate.com/github/resuldeger/laravel-friendships) [![Test Coverage](https://codeclimate.com/github/resuldeger/laravel-friendships/badges/coverage.svg)](https://codeclimate.com/github/resuldeger/laravel-friendships/coverage) [![Total Downloads](https://img.shields.io/packagist/dt/resuldeger/laravel-friendships.svg?style=flat)](https://packagist.org/packages/resuldeger/laravel-friendships) [![Version](https://img.shields.io/packagist/v/resuldeger/laravel-friendships.svg?style=flat)](https://packagist.org/packages/resuldeger/laravel-friendships) [![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat)](LICENSE) [![Join the chat at https://gitter.im/laravel-friendships/Lobby](https://badges.gitter.im/laravel-friendships/Lobby.svg)](https://gitter.im/laravel-friendships/Lobby?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
...
```php
composer require resuldeger/laravel-friendships
```

If you are using Laravel < 5.5, you need to add Resuldeger\Friendships\FriendshipsServiceProvider to your `config/app.php` providers array:
```php
Resuldeger\Friendships\FriendshipsServiceProvider::class,
```
Publish config and migrations
```
php artisan vendor:publish --provider="Resuldeger\Friendships\FriendshipsServiceProvider"
```
...
## Setup a Model
```php
use Resuldeger\Friendships\Traits\Friendable;
...
## How to use
[Check the Test file to see the package in action](https://github.com/resuldeger/laravel-friendships/blob/master/tests/FriendshipsTest.php)
